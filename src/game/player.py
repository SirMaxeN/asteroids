...
from ..constants import PLAYER_RADIUS, PLAYER_TURN_SPEED, PLAYER_SPEED, PLAYER_SHOOT_SPEED, PLAYER_SHOOT_COOLDOWN, PLAYER_ACCELERATION, PLAYER_BRAKING, PARTICLE_SPEED
...
class Player(CircleShape):
    ...
    def custom_polygon(self):
        points = [(-150, -146), (-46, -642), (-38, -649), (-38, -655), (-30, -655), (-29, -647), (-24, -647), (-22, -641), (-22, -459), (-10, -439), (-10, -366), (-4, -367), (-3, -393), (10, -393), (11, -367), (17, -366), (17, -439), (28, -459), (28, -640), (30, -647), (35, -647), (36, -654), (44, -654), (44, -648), (53, -641), (157, -133), (219, -15), (234, 162), (224, 197), (206, 205), (218, 350), (255, 365), (258, 440), (136, 533), (140, 605), (134, 604), (133, 598), (124, 587), (123, 605), (105, 612), (106, 626), (93, 629), (92, 633), (81, 633), (80, 628), (65, 624), (65, 594), (43, 594), (41, 644), (32, 646), (14, 657), (-3, 657), (-17, 646), (-28, 644), (-30, 593), (-52, 593), (-53, 625), (-67, 630), (-68, 634), (-79, 634), (-80, 630), (-93, 627), (-94, 611), (-111, 604), (-112, 586), (-121, 596), (-122, 604), (-126, 605), (-128, 531), (-246, 440), (-245.71093786521217, 366.6716985471187), (-207, 351), (-195, 202), (-214, 197), (-219, 169), (-209, -17)]
        scale = 0.04
        output = []
        for i in points:
            ...
            output.append(self.position - pygame.Vector2(i[0], i[1]).rotate(self.rotation) * scale )
        return output
    ...
    def particle(self, index: int):
        ...
        if self.velocity.y > 0.5:
            particle = Particle(self.position.x,
                                self.position.y)
